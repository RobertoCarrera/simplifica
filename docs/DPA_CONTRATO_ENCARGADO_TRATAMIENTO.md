...
| Docplanner Tech S.L. (Doctoralia) | Sincronización de disponibilidad de agenda y reservas desde Docplanner/Doctoralia (si el suscriptor activa la integración) | España (UE) | DPA firmado; datos en la UE (Art. 46 RGPD) |
