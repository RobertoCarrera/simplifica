...
serve(async (req) => {
    ...
    try {
        ...
        // TODO: In the future, check if user is an admin/owner via company_members table if needed.
        // For now, any authenticated user is better than public access, assuming this is an admin tool.
