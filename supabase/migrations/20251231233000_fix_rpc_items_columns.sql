-- Migration to fix contract_service_rpc items columns
-- Fixes:
-- 1. quote_items: discount_percentage -> discount_percent
-- 2. invoice_items: discount_percentage -> discount_percent
-- 3. invoice_items: remove discount_amount (does not exist)
-- 4. invoice_items: remove variant_id (does not exist)
-- Created on 2025-12-31-2330
