-- Migration to fix contract_service_rpc items columns (FINAL V4 - THE REAL REAL FINAL)
-- Fixes:
...
-- 8. FIX: get_next_invoice_number only accepts (series_id), not (company_id, series_id, year)
-- Created on 2025-12-31-2359
