-- Migration to fix contract_service_rpc items columns (FINAL V3 - THE REAL FINAL)
-- Fixes:
-- 1. quote_items: insert company_id (NOT NULL)
-- 2. quote_items: insert line_number (NOT NULL, no default) -> Set to 1
