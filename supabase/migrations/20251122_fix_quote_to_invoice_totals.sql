-- Fix convert_quote_to_invoice to preserve quote totals
-- The calculate_invoice_totals function recalculates totals without respecting tax settings,
-- so we remove the call and keep the quote's correct totals.
-- Date: 2025-11-22
...
begin
  ...
  -- DO NOT call calculate_invoice_totals() here!
  -- The totals from the quote are already correct and respect the tax settings.
  -- Calling calculate_invoice_totals() would recalculate them incorrectly.
