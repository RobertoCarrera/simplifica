-- Migration: Consistency Update - Use users.app_role_id
-- Description: Updates create_ticket and handle_ticket_notifications to query users.app_role_id.
...
-- 2. Update handle_ticket_notifications to use users.app_role_id
...
DECLARE
    v_recipient_id UUID;
    -- Fix: Query users JOIN app_roles for owner/admin in this company
    v_admins CURSOR FOR 
