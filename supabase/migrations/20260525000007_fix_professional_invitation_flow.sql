-- Fix professional invitation flow: auto-create professional record and enable moduloReservas
...
BEGIN
  ...
  IF v_invitation.role = 'owner' AND v_invitation.company_id IS NULL THEN
    ...
    -- Avoid ugly timestamp slugs. Detect if it already exists and return error.
  ...
  ELSE
    ...
    -- Auto-create professional record if invited as professional
