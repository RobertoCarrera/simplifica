-- Migration to fix missing number columns in RPC
-- Created on 2026-01-01-0019
-- V12 consolidated: 
-- 1. Explicitly set quote_number (Formatted as YYYY-XXXXX)
-- 2. Explicitly set invoice_number (Returned by get_next_invoice_number)
