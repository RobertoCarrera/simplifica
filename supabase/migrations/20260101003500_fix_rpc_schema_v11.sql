-- Migration to fix schema mismatches in quotes/invoices
-- Created on 2026-01-01-0018
-- V11 consolidated: 
-- 1. Remove 'gdpr_legal_basis' from quotes insert
-- 2. Use 'source_quote_id' instead of 'quote_id' in invoices
-- 3. Remove 'year', 'sequence_number', 'discount_amount' from invoices insert
-- 4. Fix item tables: line_order/line_number, tax_rate, and company_id presence
...
BEGIN
    ...
    INSERT INTO public.quotes (
        ...
        year, sequence_number, created_by
    ) VALUES (
        ...
        v_current_year, v_quote_count, v_creator_id
    ...
    -- Note: Local table uses source_quote_id and lacks year/sequence_number/discount_amount
    
    INSERT INTO public.invoices (
        company_id, client_id, source_quote_id, status, 
        ...
        now(), now() + interval '7 days', v_total_amount, 'EUR',
        v_base_price, v_tax_amount, v_creator_id, 'contract',
        v_series_id
    ...
    INSERT INTO public.invoice_items (
        ...
        v_invoice_id, v_title, 1, v_base_price,
        v_discount_percent, v_tax_percent, v_tax_amount, v_base_price, v_total_amount,
        1
    );
