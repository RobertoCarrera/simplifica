-- Rollback for 20260630000007_addon_module_exclusivity.sql
-- Restores the previous admin_upsert_addon body (from migration 0006) without
-- the module exclusivity check. Use only for emergency rollback.
