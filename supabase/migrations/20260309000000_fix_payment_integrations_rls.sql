...
-- Previous policies failed to check strict company_id matching, allowing cross-tenant access for admins.
...
-- Recreate policies with strict company_id isolation
-- 1. SELECT
