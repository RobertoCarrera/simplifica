-- Migration: Fix accept_company_invitation to use responded_at instead of updated_at for invitations table
-- The company_invitations table does not have an updated_at column, but has responded_at which is appropriate for this action.
