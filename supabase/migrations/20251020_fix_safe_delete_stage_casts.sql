-- ================================================================
-- Migration: Fix enum/text casts in safe_delete_ticket_stage
-- Date: 2025-10-20
-- Purpose: Avoid operator error "operator does not exist: stage_category = text"
--          by casting enum columns to text when comparing with text vars.
-- ================================================================
