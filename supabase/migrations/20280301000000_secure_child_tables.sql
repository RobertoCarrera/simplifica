...
-- Description: Enables RLS and adds policies to check parent tables for company access.
-- Fixes ID mismatch by joining public.users to map auth.uid() -> public.users.id
