-- Rollback for 20260630000006_addon_module_binding.sql
-- Drops the included_modules column from plan_addons and restores the
-- previous admin_upsert_addon signature (without p_included_modules).
...
ALTER TABLE public.plan_addons DROP COLUMN IF EXISTS included_modules;
