-- Actualizar convert_quote_to_invoice para pasar rectification_reason y rectifies_invoice_id
...
begin
  ...
  -- Validate state
  if v_quote.status <> 'accepted' and v_quote.status <> 'facturado' then
