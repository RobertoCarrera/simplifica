...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'tighten_booking_documents_storage_rls: skipped — relation "storage.objects" does not exist';
    RETURN;
  END IF;

  EXECUTE 'DROP POLICY IF EXISTS "Users can view booking documents" ON storage.objects';
