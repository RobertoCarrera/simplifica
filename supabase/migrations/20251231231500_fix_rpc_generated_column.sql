-- Migration to fix contract_service_rpc generated column error (full_quote_number AND full_invoice_number)
-- and ensure year/sequence_number are populated for the generation expression.
-- Created on 2025-12-31-2315
