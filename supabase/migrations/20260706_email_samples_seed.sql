...
INSERT INTO public.email_sample_fixtures (email_type, sample_data, expected_substrings) VALUES
  ...
  ('invite_client',
   ...
   ARRAY['Te han invitado a unirte a','portal de clientes','Aceptar invitación','https://app.simplificacrm.es/invite/client-1']),
  ('waitlist',
  ...
  ('password_reset',
   '{"reset_url":"https://app.simplificacrm.es/reset/abc-token"}'::jsonb,
   ARRAY['https://app.simplificacrm.es/reset/abc-token']),
  ('magic_link',
   '{"reset_url":"https://app.simplificacrm.es/magic/token-xyz"}'::jsonb,
   ARRAY['https://app.simplificacrm.es/magic/token-xyz']),
  ('welcome',
