-- Migration to fix RPC schema mismatches in local environment
-- Created on 2026-01-01-0016
-- V9 consolidated: 
-- 1. Remove references to non-existent 'price_cents' column
-- 2. Fix variant price extraction from 'pricing' JSONB
-- 3. Fix missing 'billing_period' column in variants
