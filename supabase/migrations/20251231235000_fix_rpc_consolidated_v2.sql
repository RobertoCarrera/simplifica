-- Migration to fix contract_service_rpc items columns (FINAL V2)
-- Fixes:
-- 1. quote_items: insert company_id (NOT NULL)
-- 2. quote_items: discount_percentage -> discount_percent
-- 3. invoice_items: discount_percentage -> discount_percent
-- 4. invoice_items: remove discount_amount / variant_id
-- 5. quotes: full_quote_number removal (generated)
-- 6. invoices: full_invoice_number removal (generated)
-- Created on 2025-12-31-2350
...
BEGIN
    ...
    INSERT INTO public.quotes (
        ...
        client_id,
        quote_number,
        -- REMOVED full_quote_number (generated ALWAYS)
        year, -- Added
        ...
        subtotal,
        discount_amount, -- Correct column name
        tax_amount,
        total_amount,
        ...
        v_year, -- year
        v_quote_number::integer, -- sequence_number
    ...
    INSERT INTO public.quote_items (
        company_id, -- ADDED: Required NOT NULL
        quote_id,
        service_id,
        variant_id,
        description,
        quantity,
        unit_price,
        discount_percent, -- FIX: discount_percentage -> discount_percent
        discount_amount,
        tax_rate,
        subtotal,
        tax_amount,
    ...
    INSERT INTO public.invoice_items (
        invoice_id,
        service_id,
        -- REMOVED variant_id (does not exist in invoice_items)
        description,
        quantity,
        unit_price,
        discount_percent, -- FIX: discount_percentage -> discount_percent
        -- REMOVED discount_amount (does not exist in invoice_items)
        tax_rate,
        subtotal,
        tax_amount,
        total
    ...
    SELECT
        ...
        quantity,
        unit_price,
        discount_percent, -- Maps to discount_percent
        -- discount_amount
        tax_rate,
        subtotal,
        tax_amount,
