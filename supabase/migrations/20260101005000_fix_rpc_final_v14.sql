-- Migration to fix RPC with invoice_series population
-- Created on 2026-01-01-0022
-- V14 consolidated (FINAL): 
-- 1. FIX: Populate invoice_series (TEXT) from invoice_series.series_code
-- 2. FIX: invoice_status 'draft'
-- 3. FIX: invoice_type 'normal'
-- 4. FIX: quote_number format YYYY-XXXXX
-- 5. FIX: invoice_number from DB sequence
-- 6. FIX: All column name corrections
