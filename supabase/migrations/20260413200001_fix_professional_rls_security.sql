...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'fix_professional_rls_security: skipped professional_schedules policies — table does not exist';
    RETURN;
  END IF;

  EXECUTE 'DROP POLICY IF EXISTS "professional_schedules_select" ON professional_schedules';
  EXECUTE $q$
  ...
  EXECUTE 'DROP POLICY IF EXISTS "professional_schedules_insert" ON professional_schedules';
  EXECUTE $q$
  ...
  EXECUTE 'DROP POLICY IF EXISTS "professional_schedules_update" ON professional_schedules';
  EXECUTE $q$
  ...
  EXECUTE 'DROP POLICY IF EXISTS "professional_schedules_delete" ON professional_schedules';
  EXECUTE $q$
