-- Migration to fix contract_service_rpc items columns (FINAL V6 - ABSOLUTE FINAL)
-- Fixes Consolidated:
...
-- 9. invoice: issue_date -> invoice_date
-- 10. invoice: remove irpf_amount (does not exist)
-- Created on 2026-01-01-0005
...
BEGIN
    ...
    INSERT INTO public.invoices (
        ...
        subtotal,
        tax_amount,
        -- irpf_amount, -- REMOVED: does not exist
        total,
        source_quote_id,
        created_by
    ) VALUES (
