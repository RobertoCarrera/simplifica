-- Migration: Update ensure context-aware module fetching
...
begin
    ...
    -- If p_input_company_id is provided, use it.
    -- Otherwise, try to infer from last active or just pick one? 
    -- Ideally frontend passes it. If null, we might default to "Staff" logic if exists, or "Client" if not.
    
    -- Let's resolve the "Persona" (User vs Client) based on the company context.
