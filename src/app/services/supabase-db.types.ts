...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      company_settings: {
        Row: {
          ...
          waitlist_notification_window: number | null;
      ...
      marketing_campaigns: {
        Row: {
          ...
          trigger_type: Database['public']['Enums']['campaign_trigger_type'] | null;
      ...
      ticket_stages: {
        Row: {
          ...
          updated_at: string | null;
          workflow_category: Database['public']['Enums']['workflow_category'] | null;
        };
        Insert: {
          color?: string | null;
          company_id?: string | null;
    ...
    Enums: {
      ...
      content_status: 'idea' | 'copy' | 'design' | 'review' | 'scheduled' | 'published';
