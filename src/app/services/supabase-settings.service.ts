...
export interface CompanySettings {
  ...
  automation?: {
    reminder_24h?: { enabled: boolean; offset_hours: number; channel?: 'email' };
    reminder_1h?: { enabled: boolean; offset_hours: number; channel?: 'email' };
    review_request?: { enabled: boolean; offset_hours: number; channel?: 'email' };
  } | null;
  updated_at?: string;
}
