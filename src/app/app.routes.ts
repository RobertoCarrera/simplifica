...
export const routes: Routes = [
  ...
  },
  {
    path: 'productos',
    loadComponent: () =>
      import('./features/products/products/products.component').then((m) => m.ProductsComponent),
  ...
  },
  {
    path: 'chat',
    loadComponent: () =>
      import('./features/chat/anychat/anychat.component').then((m) => m.AnychatComponent),
    canActivate: [AuthGuard, ModuleGuard],
  ...
  {
    path: 'configuracion/booking-types',
    loadComponent: () =>
  ...
  {
    path: 'empresa/portal-clientes',
    loadComponent: () =>
      import('./features/admin/client-portal/client-portal-admin.component').then(
        (m) => m.ClientPortalAdminComponent,
      ),
    canActivate: [AuthGuard, OwnerAdminGuard],
  },
  ...
  // Client portal contracted services (placeholder - to be implemented)
  {
    ...
    canActivate: [AuthGuard, ClientRoleGuard, ModuleGuard],
    data: { moduleKey: 'moduloServicios' },
  },
  // Client portal devices
  {
    path: 'portal/dispositivos',
    loadComponent: () =>
  ...
  // Client portal contracts
  {
    ...
    loadComponent: () =>
      import('./features/client-portal/pages/contracts/client-contracts.component').then(
        (m) => m.ClientContractsComponent,
      ),
    canActivate: [AuthGuard, ClientRoleGuard],
  },

  // Waitlist page — accessible to both clients (passive subscriptions + claim) and staff (admin overview)
  {
    path: 'waitlist',
    loadComponent: () =>
  ...
  // Public payment pages (NO AUTH REQUIRED)
  {
    path: 'pago/:token',
    loadComponent: () =>
      import('./features/payments/public/public-payment.component').then(
        (m) => m.PublicPaymentComponent,
      ),
  },
  {
    path: 'pago/:token/completado',
    loadComponent: () =>
      import('./features/payments/success/payment-success.component').then(
        (m) => m.PaymentSuccessComponent,
      ),
  },
  {
    path: 'pago/:token/cancelado',
    loadComponent: () =>
      import('./features/payments/cancelled/payment-cancelled.component').then(
