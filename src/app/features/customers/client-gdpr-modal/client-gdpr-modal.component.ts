    ...
    @if (isOpen) {
      ...
      >
        ...
        >
          <!-- Header -->
          <div
            class="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-700 bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm"
          >
          ...
          <!-- Footer -->
          <div
            class="p-4 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-slate-900 flex justify-end"
          >
            <button
              (click)="close()"
...
export class ClientGdprModalComponent implements OnInit, OnDestroy {
