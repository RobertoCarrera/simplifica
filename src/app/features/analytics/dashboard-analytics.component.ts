        ...
        <div class="flex-1 overflow-auto space-y-6">
          ...
          @if (error()) {
            ...
            >
              ...
              <button
                (click)="clearError()"
                class="text-red-700 dark:text-red-300 hover:text-red-900 dark:hover:text-red-200"
              >
          ...
          @if (!isLoading()) {
            ...
            <div
              class="rounded-xl border-2 border-emerald-200 dark:border-emerald-800 bg-emerald-50/50 dark:bg-emerald-950/20 p-4"
            >
              <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p class="text-xs text-emerald-600 dark:text-emerald-400">
                    Facturas emitidas · Dinero confirmado
                  </p>
                </div>
              </div>
              ...
              <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                @for (metric of invoiceMetrics(); track metric.id) {
                  <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 p-3 md:p-4 border border-emerald-100 dark:border-emerald-900/50"
                  >
                    ...
                    <div class="space-y-0.5">
                      <p
                        class="text-[10px] md:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide"
                      >
                        {{ metric.title }}
                      </p>
                      <p
                        class="text-lg md:text-xl font-bold text-gray-900 dark:text-white break-words"
                      >
                        {{ metric.value }}
                      </p>
            ...
            <div
              class="rounded-xl border-2 border-violet-200 dark:border-violet-800 bg-violet-50/50 dark:bg-violet-950/20 p-4"
            >
              <div class="flex items-center gap-3 mb-4">
                <div
                  class="w-10 h-10 rounded-full bg-violet-100 dark:bg-violet-900 flex items-center justify-center"
                >
                  <svg
            ...
            @if (hasTicketsModule()) {
              <div
                class="rounded-xl border-2 border-cyan-200 dark:border-cyan-800 bg-cyan-50/50 dark:bg-cyan-950/20 p-4"
              >
                <div class="flex items-center gap-3 mb-4">
                  <div
            ...
            @if (quoteHistoricalData().length === 0 && invoiceHistoricalData().length === 0) {
              ...
              >
                <div
                  class="w-16 h-16 md:w-20 md:h-20 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mb-4 mx-auto"
                >
                  <svg
                    class="w-8 h-8 md:w-10 md:h-10 text-gray-400 dark:text-gray-500"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <h3
                  class="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2"
                >
