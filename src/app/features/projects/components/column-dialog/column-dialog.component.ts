...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, AppModalComponent],
  template: `
    <app-modal [visible]="visible" (close)="onClose()">
      <div class="w-full max-w-2xl mx-auto">
        ...
        >
          <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
              Administra, reordena y configura las etapas del tablero.
            </p>
          </div>
          <button
            (click)="onClose()"
            class="text-gray-400 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-200 transition-colors p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700"
          >
            <svg
        ...
        <div class="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
          <!-- Stages List -->
          <div class="space-y-3">
            @for (s of sortedStages; track s; let i = $index) {
              <div
              ...
              >
                ...
                <div class="flex flex-col gap-1">
                  <button
                    (click)="moveStage(-1, i)"
                    [disabled]="i === 0"
                    class="text-gray-400 hover:text-blue-500 disabled:opacity-30"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-4 w-4"
                  ...
                  <div class="flex flex-wrap gap-4 mt-2">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer group">
                      <div class="relative inline-flex items-center">
                        <input
                          type="checkbox"
                          [checked]="s.is_review"
                          (change)="toggleStageType(s, 'review')"
                          class="sr-only peer"
                        />
                        <div
                          class="w-8 h-4 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-amber-300 dark:peer-focus:ring-amber-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[0px] after:left-[0px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:after:border-gray-600 peer-checked:bg-amber-500"
                        ></div>
                      </div>
                      <span
                        class="text-xs text-gray-500 dark:text-gray-400 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors flex items-center gap-1"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="h-3 w-3"
                    ...
                    <label class="flex items-center gap-2 cursor-pointer group">
                      <div class="relative inline-flex items-center">
                        <input
                          ...
                          (change)="toggleStageType(s, 'default')"
                          class="sr-only peer"
                        />
                        <div
                          class="w-8 h-4 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[0px] after:left-[0px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:after:border-gray-600 peer-checked:bg-blue-500"
                        ></div>
                      </div>
                      <span
                        class="text-xs text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors flex items-center gap-1"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="h-3 w-3"
                    ...
                    <label class="flex items-center gap-2 cursor-pointer group">
                      <div class="relative inline-flex items-center">
                        <input
                          type="checkbox"
                          [checked]="s.is_landing"
                          (change)="toggleStageType(s, 'landing')"
                          class="sr-only peer"
                        />
                        <div
                          class="w-8 h-4 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-indigo-300 dark:peer-focus:ring-indigo-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[0px] after:left-[0px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:after:border-gray-600 peer-checked:bg-indigo-500"
                        ></div>
                      </div>
                      <span
                        class="text-xs text-gray-500 dark:text-gray-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors flex items-center gap-1"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="h-3 w-3"
                    ...
                    <label class="flex items-center gap-2 cursor-pointer group">
                      <div class="relative inline-flex items-center">
                        <input
                          type="checkbox"
                          [checked]="s.is_final"
                          (change)="toggleStageType(s, 'final')"
                          class="sr-only peer"
                        />
                        <div
                          class="w-8 h-4 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[0px] after:left-[0px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:after:border-gray-600 peer-checked:bg-green-500"
                        ></div>
                      </div>
                      <span
                        class="text-xs text-gray-500 dark:text-gray-400 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors flex items-center gap-1"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="h-3 w-3"
          ...
          <!-- Add New Stage -->
          <div
            class="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border border-gray-100 dark:border-gray-700 flex gap-3 items-center"
          >
            <div class="flex-1">
              <input
                type="text"
...
export class ColumnDialogComponent implements OnChanges {
  ...
  moveStage(direction: -1 | 1, index: number) {
    ...
    // Swap locally
    [this.sortedStages[index], this.sortedStages[newIdx]] = [
      this.sortedStages[newIdx],
      this.sortedStages[index],
    ];
  ...
  confirmDelete(stage: ProjectStage) {
    if (
      !confirm(
        `¿Estás seguro de que quieres eliminar la etapa "${stage.name}"? Los proyectos que estén en ella perderán su etapa asignada (quedarán sin etapa o necesitarán reasignación).`,
      )
    ) {
      return;
    }
