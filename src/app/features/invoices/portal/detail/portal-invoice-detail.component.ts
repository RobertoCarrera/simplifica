        ...
        <div class="max-w-5xl mx-auto">
          <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex gap-3">
              ...
              @if (inv.payment_status !== 'paid' && inv.payment_status !== 'pending_local') {
                <button
          ...
          @if (
            ...
            >
              ...
              <span class="text-amber-700 dark:text-amber-300 font-medium"
                >Pago pendiente - Selecciona "Pagar ahora" para completar la transacción</span
              >
            </div>
          }
          @if (inv.payment_status === 'pending_local') {
            <div
              class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg flex items-center gap-3"
            >
              <svg
              ...
              <div class="flex flex-col flex-1">
                <span class="text-blue-700 dark:text-blue-300 font-bold"
                  >Pago local solicitado</span
                >
                <span class="text-blue-600 dark:text-blue-400 text-sm"
                  >Has indicado que pagarás en efectivo o localmente. Pónte en contacto con la
                  administración.</span
                >
              </div>
              <button
                (click)="openPaymentSelector(inv)"
                class="ml-auto text-sm px-4 py-2 bg-white text-blue-600 border border-blue-200 rounded hover:bg-blue-50 transition-colors"
              >
                Pagar Online
              </button>
            </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            >
              ...
              <div class="flex items-center gap-2">
                <span class="text-base font-semibold text-gray-900 dark:text-gray-100 capitalize">{{
