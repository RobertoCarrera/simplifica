...
@Component({
  ...
  imports: [],
  template: `
    @if (invoice && invoice.verifactu_hash) {
      <div
        class="inline-flex items-center gap-2 px-2 py-1 rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-200 cursor-pointer"
        (click)="toggleQR()"
      >
