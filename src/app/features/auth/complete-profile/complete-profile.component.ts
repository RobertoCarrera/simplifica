      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form class="space-y-6" (submit)="onSubmit($event)">
            ...
            <!-- Nombre de Empresa -->
            <div>
              <label for="companyName" class="block text-sm font-medium text-gray-700">Nombre de tu Empresa / Organización</label>
              <div class="mt-1">
            ...
            <div class="text-center mt-4">
              <button type="button" (click)="logout()" class="text-sm text-gray-500 hover:text-gray-900 underline">
