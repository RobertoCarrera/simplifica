...
export class ProfessionalContractDialogComponent implements OnInit {
  ...
  blocks = [
    ...
    },
    {
      ...
      content: '<p data-label="Párrafo">Escribe aquí el contenido...</p>',
    },
    {
      label: 'Lista',
      icon: 'fas fa-list-ul',
    ...
    },
    {
      ...
      content:
        '<div data-label="Firma" style="margin-top: 50px; border-top: 1px solid #ccc; width: 200px; padding-top: 10px;">Firma del Empleado</div>',
    },
  ];
  ...
  replacePlaceholders(content: string): string {
    ...
    processed = processed.replace(
      new RegExp('{{professional_name}}', 'g'),
  ...
  async createDocument() {
    ...
    try {
      await this.professionalService.uploadProfessionalDocument(
        this.professionalId,
        file,
        'contract',
      );
