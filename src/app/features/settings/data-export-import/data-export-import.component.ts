...
import {
  ...
  CsvMappingResult,
  FieldMapping,
} from '../../../shared/ui/csv-header-mapper/csv-header-mapper.component';
import {
  SupabaseCustomersService,
  CustomerFilters,
} from '../../../services/supabase-customers.service';
...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, CsvHeaderMapperComponent],
...
export class DataExportImportComponent {
  ...
  get currentFieldOptions() {
    return this.selectedDataType() === 'customers'
