...
-- Dashboard: https://supabase.com/dashboard/project/ufutyjbqfjrlzkprvyvs/sql/new
...
WHERE table_name = 'invoices' 
  AND column_name IN ('stripe_payment_url', 'paypal_payment_url', 'stripe_payment_token', 'paypal_payment_token');
